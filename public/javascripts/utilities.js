...
waymarkApp.utilities.ajaxHelper = (function (jQuery, t, cookieHelper) {
        ...
        ajax = function (ajaxOptions, type, options) {
            ...
            jQuery.ajax({
                ...
                beforeSend: function (req) {
                    req.setRequestHeader("Authorization", "Bearer " + cookieHelper.getCookie(window.consts.authCookie));
                },
                type: type,
...
})($, toastr, waymarkApp.utilities.cookieHelper);
